...
head:
  - - meta
    - name: description
      content: ShuYou User Agreement
  - - meta
    - name: keywords
      content: ShuYou, terms, service, OpenAI, Anthropic, Claude, GPT
---

# ShuYou User Agreement

Last updated: 3/17/2026

Thank you for using ShuYou! Before you access Our Service, please read the ShuYou User Agreement.

ShuYou's products and services (referred to as "Our Service") are owned and operated by AI Force Singapore Pte. Ltd. (referred to herein as "we," "us," or "the Company"). Before using our products and services, the user (referred to as "you"), must carefully and thoroughly read and understand ShuYou User Agreement (referred to as "this Agreement"). **Pay special attention to the bolded clauses, including but not limited to those concerning limitations or exclusions of the Company's liability, restrictions on your rights, and the governing law and dispute resolution mechanisms.**
...
**1.1** We / "The Company": Refers to AI Force Singapore Pte. Ltd, the operator of the ShuYou's products and services.

**1.2** "Our Service" / "ShuYou": Refers to Our Service we provide via the ShuYou website（[https://shuyou.ai/](https://shuyou.ai/)）, which curates and offers access to multiple top-tier algorithm models for users.
...
**4.2** As a ShuYou user, you agree to comply with the following usage guidelines when using Our Service:
...
**5.1** We fully respect the protection of your personal information. You can read the ShuYou Privacy Policy to understand the purposes, methods, and scope of our collection and use of your personal information while you use Our Service, your rights regarding your personal information, and the security measures we implement to protect your information.
...
- **Email:** [support@shuyou.ai](mailto:support@shuyou.ai)
...
**9.1.2 Subscription:** **if you chose to subscribe for our ShuYou Builder Plan, and the fees calculated based on the PAYG pricing rates for the tokens actually consumed as of you send the refund application email ("Consumption Fee") are less than the subscription fees you have actually paid ("Subscription Fee"), you may apply for a refund of the balance between the Consumption Fee and the Subscription Fee within twenty-four (24) hours after subscription. No fees will be refund after twenty-four (24) hours after subscription.**
...
**9.3 Refund Application:** **Please send your refund application to [support@shuyou.ai](mailto:support@shuyou.ai), and provide your account email / account ID, purchase/subscription starting date and time (YYYY−MM−DDHH), purchase/subscription fee amount, current unused credits balance, reason for refund request and any other information we may require from time to time.**
