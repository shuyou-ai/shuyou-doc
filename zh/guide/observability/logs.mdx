...
head:
  ...
  - - meta
    - name: keywords
      content: ShuYou, guide, tutorial, logs, Anthropic, Claude, API
---

# 请求日志

ShuYou 提供了完善的日志系统，帮助您实时监控和分析所有 API 调用记录。通过日志功能，您可以查看每次请求的详细信息，包括 Token 使用量、费用、性能指标等，从而更好地优化您的应用和控制成本。

## 日志查看

### Logs 界面

![logs](https://cdn.marmot-cloud.com/storage/ShuYou/2026/02/04/hRufjb7/C1924254-C6BA-4BE9-A8EA-37ED8DA28955.png)
...
![logs](https://cdn.marmot-cloud.com/storage/ShuYou/2026/02/04/oB9QNOh/20260204163548.jpg)
...
![logs](https://cdn.marmot-cloud.com/storage/ShuYou/2026/02/04/sxs9R74/20260204163702.jpg)
...
**订阅用户（Subscription）：**
![logs](https://cdn.marmot-cloud.com/storage/ShuYou/2026/02/04/LsEH46N/20260204163622.jpg)
...
![logs](https://cdn.marmot-cloud.com/storage/ShuYou/2026/02/04/z7KBWgU/20260204163740.jpg)
...
- **Request（请求数据）**：
  - `User -> ShuYou`：用户发送给 ShuYou 的原始请求
  - `ShuYou -> Origin`：ShuYou 转发给上游供应商的请求
- **Response（响应数据）**：
  - `ShuYou -> User`：ShuYou 返回给用户的响应
  - `Origin -> ShuYou`：上游供应商返回给 ShuYou 的原始响应
