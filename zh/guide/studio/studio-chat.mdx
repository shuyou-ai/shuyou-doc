...
Studio-Chat 是 ShuYou 平台提供的智能对话工具，支持多模型对话、PK 模式、Artifacts 生成、图像生成等多种高级功能。本文档将帮助您快速掌握 Studio-Chat 的核心功能。

## 基础功能

### 开始新对话

1. 访问 [Studio-Chat](https://shuyou.ai/platform/chat?chatId=new_chat)
2. 在页面底部的输入框中输入您的问题
