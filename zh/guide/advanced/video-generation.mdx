...
- [Doubao Seedance 2.0 视频生成](/zh/api-reference/video-series/seedance/doubao-seedance-2.0-video-generate) — `POST /v1/predictions`（`function: video`）
- [Doubao Seedance 2.0 Fast 视频生成](/zh/api-reference/video-series/seedance/doubao-seedance-2.0-fast-video-generate) — `POST /v1/predictions`（`function: video`）
- [HappyHorse 1.0 T2V 视频生成](/zh/api-reference/video-series/happyhorse/happyhorse-1.0-t2v-video-generate) — `POST /v1/predictions`（`function: video`）
- [HappyHorse 1.0 R2V 视频生成](/zh/api-reference/video-series/happyhorse/happyhorse-1.0-r2v-video-generate) — `POST /v1/predictions`（`function: video`）
- [HappyHorse 1.0 I2V 视频生成](/zh/api-reference/video-series/happyhorse/happyhorse-1.0-i2v-video-generate) — `POST /v1/predictions`（`function: video`）
- [HappyHorse 1.0 视频编辑](/zh/api-reference/video-series/happyhorse/happyhorse-1.0-video-edit-video-generate) — `POST /v1/predictions`（`function: video`）
- 任务查询：[查询预测任务](/zh/api-reference/task-management/get-prediction)
