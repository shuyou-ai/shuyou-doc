...
OpenAI 兼容图像 API（`POST /v1/images/generations`）及交互式 Playground：

- [Gemini Flash](/zh/api-manual/image-series/gemini/gemini-flash-image-generate)
- [Gemini Flash（免费）](/zh/api-manual/image-series/gemini/gemini-flash-image-free-generate)
- [Gemini Pro](/zh/api-manual/image-series/gemini/gemini-pro-image-generate)
