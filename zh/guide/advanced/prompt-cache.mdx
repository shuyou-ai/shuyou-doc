...
[GPT-5 模型详情页](https://shuyou.ai/openai/gpt-5)

![GPT-5模型详情页](https://cdn.marmot-cloud.com/storage/ShuYou/2025/10/15/gZT4EZo/gpt-5.png)
...
你可以通过在 ShuYou Logs 界面查看请求的 Prompt Token 明细，如下图所示

![查看缓存数据](https://cdn.marmot-cloud.com/storage/ShuYou/2025/10/15/5otcsXY/logs.png)

<Tip title="注意 log 开关的影响">
注意您需要在 Strategy-API Call Logging 界面打开开关才会进行相关数据的 log。

![Log开关](https://cdn.marmot-cloud.com/storage/ShuYou/2025/10/15/NiNFDys/log-strategy.png)
</Tip>
