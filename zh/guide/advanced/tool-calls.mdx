...
head:
  ...
  - - meta
    - name: keywords
      content: AGIPower, guide, tutorial, tool, calls, OpenAI, GPT, API
---
...
工具调用是您的应用程序和模型通过 AGIPower API 进行的多轮对话。工具调用流程有五个主要步骤：
