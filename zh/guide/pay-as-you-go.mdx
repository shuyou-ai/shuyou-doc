...
欢迎使用 **AGIPower Pay As You Go（按量付费）** 方案！本指南将帮助你了解按量付费的核心优势，以及如何充值、管理余额和创建生产级 API Key。
...
**Pay As You Go（按量付费）** 是 AGIPower 为企业客户和生产环境量身打造的计费方案。与订阅制不同，按量付费采用**预充值 + 按实际消耗扣费**的模式，让你只为实际使用的 API 调用付费。
...
访问 **[AGIPower 控制台](https://agipower.ai/plantform/pay-as-you-go)**，导航到 **Manage > Pay As You Go** 页面。

![Pay As You Go 页面](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/rsGoojf/pay-as-you-go.png)
...
![创建 API Key](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/BNdWYST/pay-as-you-go-details.png)
...
创建 API Key 后，你可以在代码中使用该 Key 调用 AGIPower API。使用方式与快速开始指南中的方法完全相同，只需替换为你的 Pay As You Go API Key：
...
![积分明细](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/YqxRLvm/pay-as-you-go-keys.png)
...
- 访问 [成本分析页面](https://agipower.ai/settings/cost)，查看详细的成本归因和使用趋势
