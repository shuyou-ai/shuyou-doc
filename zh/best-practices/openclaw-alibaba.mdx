# 阿里云部署 OpenClaw 并集成 ShuYou 实践

> 通过 [ShuYou](https://shuyou.ai/)，你可以第一时间体验到：
>
> - **OpenAI GPT-5.2** —— 通用大模型，代码生成和逻辑推理能力顶尖
> - **Anthropic Claude Sonnet 4.6** —— 超长上下文，复杂文档处理利器
> - **Google Gemini 3.1 Pro** —— 原生多模态支持，图文理解能力强
>
> 💡 **无需分别注册 OpenAI、Google、Anthropic 等海外平台**，一个 ShuYou 账号全搞定，告别复杂的信用卡绑定和区域限制。
...
2. 已注册 ShuYou 账号并获取 API 密钥

---

### 第 1 步：获取 ShuYou API Key

1. 登录 [ShuYou 控制台](https://shuyou.ai)
2. 进入「API 密钥」页面
3. 点击「创建新密钥」
...
验证成功的标志：列表中出现 `ShuYou/openai/gpt-5.2` 等 ShuYou 模型。
...
![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/UGt4JSE/1772423318928-3482a147-3fbc-49a1-9f83-02dfdf87d68b.png)
...
![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/BhcI5qH/1772430910203-4eb0b758-ccb1-4428-a326-af8cc7aba537.png)
...
![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/9vNTPwc/1772430228612-c38c93c8-ff1f-4821-b3cf-de8eb555810f.png)
...
![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/cmiFDG7/1772432608573-a92e03aa-200b-4736-ba3b-8e26fd2b75c5.png)

3. 不做任何修改，直接保存并发布

![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/OpcRPhn/1772432662944-52728c1a-f849-490a-9244-3f3da247d747.png)

4. 记录模板 ID，后续配置需要

![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/IecBwbz/1772433308898-862ed747-c3a5-4f2c-b780-2f97336e5d82.png)
...
![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/5rf8dbJ/1772433461434-c8358115-1984-4f53-b133-a67f7327e645.png)
...
配置一个定时任务，每天检查 ShuYou 是否有新模型上线，第一时间体验最新模型能力。

![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/FUtNPv7/1772435933384-652b08f3-896f-4c0a-b7ad-9ad547f2a97c.png)

在 Web UI 中可以看到配置的定时任务，可手动触发任务，验证逻辑正确性。

![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/pgABFg0/1772436961965-e1695579-508d-48a8-af26-a2ae3c073d40.png)

实际执行效果：机器人将自动推送新模型公告到钉钉群。

![openclaw-alibaba](https://cdn.marmot-cloud.com/storage/ShuYou/2026/03/02/wSMhI1h/1772436081263-513f638e-086d-4313-aa08-4df49058a693.png)

## 相关资源

- [ShuYou 官方文档](https://shuyou.ai/docs/zh/best-practices/openclaw.html)
