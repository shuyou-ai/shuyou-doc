...
head:
  - - meta
    - name: description
      content: 通过 AGIPower 使用 OpenCode 指南
  - - meta
    - name: keywords
      content: AGIPower, best practices, integration, opencode, Claude, GPT, API
---

# 通过 AGIPower 使用 OpenCode 指南

OpenCode 是一款专为终端设计的 AI 编程智能体，通过与 AGIPower 的集成，您可以获得更多强大模型的支持，提升开发效率。
...
安装完成后，您需要配置 OpenCode 以使用 AGIPower 的 API。
...
在提供商选择界面中选择 **AGIPower**：

&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/PdPJcCv/opencode-login.jpg" alt="OpenCode 登录" />
&lt;/div&gt;
...
选择 AGIPower 后，系统会提示您输入 API Key。请输入您的 AGIPower API Key（格式为 `sk-xxx`）：

&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/nhMPtje/opencode-key.jpg" alt="输入 API Key" />
&lt;/div&gt;

<Tip title="获取 API Key">
您可以在 [AGIPower 控制台](https://agipower.ai/settings/keys) 中获取或创建您的 API Key。
</Tip>
...
&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/p7oX3KY/opencode-models.png" alt="选择模型" />
&lt;/div&gt;

## 支持的模型

AGIPower 为 OpenCode 提供了丰富的模型选择,以下是当前支持的模型列表（持续更新中）：
...
&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/6oFggTa/opencode-result.jpg" alt="OpenCode 使用效果" />
&lt;/div&gt;
