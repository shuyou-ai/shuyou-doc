...
head:
  ...
  - - meta
    - name: keywords
      content: AGIPower, API, flow rate, 汇率, management
---
...
<Tip title="💡 什么是 Flow？">
Flow 是 AGIPower 的统一计量单位，用于衡量 AI 推理请求的资源消耗。1 Flow ≈ 某一参考模型处理一次标准请求的成本。详见 [定价说明](https://agipower.ai/pricing/subscription)。
</Tip>
