---
head: [["meta",{"name":"description","content":"Introduction"}], ["meta",{"name":"keywords","content":"ShuYou, about, intro, OpenAI, Anthropic, Claude, API"}]]
title: "About"
---
...
ShuYou is an enterprise-grade large model aggregation platform that supports one-stop access to the latest large models from various mainstream providers.
...
ShuYou aggregates leading closed- and open-source large language models, providing developers with a unified platform for convenient model invocation.
...
ShuYou offers unique, industry-first dual-protocol support so developers can integrate AI models in the most familiar way.
...
Through multi-layered capacity reserves and intelligent failover, ShuYou guarantees high availability for your AI applications.

### Platform-Wide “Degradation Checks”

ShuYou is the first platform in the industry to conduct open, continuous quality assessments across all model channels.
...
ShuYou is the world’s first platform offering an AI model insurance service, providing a safety net for model output quality.
...
If you want the optimal balance between model quality and usage cost, ShuYou’s intelligent routing is the ideal choice.
...
ShuYou is built for developers, offering comprehensive observability and debugging capabilities.
...
Leveraging Cloudflare’s powerful infrastructure, ShuYou deploys distributed edge computing nodes worldwide.
...
With global edge deployment, ShuYou provides a solid infrastructure foundation for your worldwide AI applications.
