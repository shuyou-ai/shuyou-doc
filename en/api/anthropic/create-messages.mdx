...
head:
  ...
  - - meta
    - name: keywords
      content: AGIPower, API, documentation, create, messages, new, Anthropic, Claude
---
...
```
POST https://api.agipower.ai/v1/messages
```

AGIPower supports the Anthropic API. See the API call examples for how to use it.
...
- This is a AGIPower-defined model name, for example:
...
const anthropic = new Anthropic({
  // 2. Replace with the API Key you obtained from the AGIPower user console
...
client = anthropic.Anthropic(
    # Replace with the API Key you obtained from the AGIPower user console
...
curl https://api.agipower.ai/v1/messages \
     --header "x-api-key: $AGIPower_API_KEY" \
