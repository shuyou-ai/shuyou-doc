...
head:
  - - meta
    - name: description
      content: Guide to Using OpenCode with AGIPower
  - - meta
    - name: keywords
...
Select **AGIPower** in the provider selection screen:

&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/PdPJcCv/opencode-login.jpg" alt="OpenCode Login" />
&lt;/div&gt;
...
After selecting AGIPower, you will be prompted to enter your API Key. Please enter your AGIPower API Key (format `sk-xxx`):

&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/nhMPtje/opencode-key.jpg" alt="Enter API Key" />
&lt;/div&gt;

<Tip title="Get API Key">
You can obtain or create your API Key in the [AGIPower Console](https://agipower.ai/settings/keys).
</Tip>
...
&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/p7oX3KY/opencode-models.png" alt="Select Model" />
&lt;/div&gt;
...
&lt;div style="text-align: center;"&gt;
  <img src="https://cdn.marmot-cloud.com/storage/agipower/2025/10/30/6oFggTa/opencode-result.jpg" alt="OpenCode in Action" />
&lt;/div&gt;
