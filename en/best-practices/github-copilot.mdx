...
head:
  - - meta
    - name: description
      content: Guide to Using VS Code Copilot with AGIPower
  - - meta
    - name: keywords
      content: AGIPower, best practices, integration, copilot, API
---

# Guide to Using VSCode Github Copilot with AGIPower

## Overview

Visual Studio Code Copilot is an AI programming assistant from Microsoft integrated into the VS Code editor. It provides intelligent suggestions, auto-completion, and code generation as you write code. With AGIPower, you can use your own API key to power VS Code Copilot, enjoying a more flexible and cost-effective AI programming experience.

<Tip title="Usage Tips">

- Ensure your VS Code version is up to date.
- Have your AGIPower API key ready.
- It is recommended to read the full guide first to understand the detailed configuration steps.
</Tip>

## Quick Start

Start your AGIPower Copilot journey in just a few simple steps:

1.  Install [Visual Studio Code](https://code.visualstudio.com/) version 1.104.0 or higher.
2.  📥 **Install Extension**: Click [here](https://marketplace.visualstudio.com/items?itemName=hugehardzhang.agipower-copilot) to install the plugin.
...
5.  ✅ **Select AGIPower**: Click "Add Models" and select the "AGIPower" provider.
6.  🔑 **Configure Key**: Enter your AGIPower API Key (the key will be securely stored locally).
...
#### 2. Install AGIPower Copilot Extension
...
3. Type "AGIPower" in the search box.
4. Find the extension published by `hugehardzhang` and click **Install**.

![Search and install AGIPower Copilot extension in VS Code Marketplace](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/jNchPhz/agipower-market.png)

**Method 2: Direct Link Installation**

1. Click [AGIPower Copilot Extension Page](https://marketplace.visualstudio.com/items?itemName=hugehardzhang.agipower-copilot).
...
![Open VS Code Copilot Chat Interface](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/FrPnxs5/select-agipower-model.jpg)
![Open VS Code Copilot Chat Interface Select manage models](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/NUnBhZm/vscode-manager-model.jpg)
...
4. Find and select **"AGIPower"** from the provider list.

![Manage models in Copilot Chat and add AGIPower provider](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/XUB0icf/vscode-manager-select-agipower.jpg)

#### 5. Configure API Key

1. After selecting AGIPower, you will see an **API Key** input box.
2. Enter your AGIPower API Key (if you don't have one, please visit [https://agipower.ai](https://agipower.ai) to register and get one).
3. The API key will be securely encrypted and stored locally; it will not be uploaded to any server.

![Enter AGIPower API Key for configuration](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/2AbsJxq/insert-agipower-apikey.png)
...
![Select AGIPower models to use in Copilot](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/FrPnxs5/select-agipower-model.jpg)
![Select AGIPower models to use in Copilot](https://cdn.marmot-cloud.com/storage/agipower/2025/12/20/UJGgqnf/chat-select-agipower-model.png)

#### 7. Start Using

Once configured, you can:

- Switch between different AGIPower models in the model selector.
...
- [AGIPower Official Website](https://tbox.tech)
- [AGIPower API Documentation](https://docs.tbox.tech)
- [Get API Key](https://tbox.tech)
- [VS Code Copilot Official Documentation](https://code.visualstudio.com/docs/copilot/overview)

## Changelog

If you have questions or suggestions, feel free to provide feedback via [GitHub Issues](https://github.com/agipower/agipower/issues).
