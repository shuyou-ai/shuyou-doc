---
pageClass: api-page
title: List Models (detailed reference)
sidebarTitle: List Models (reference)
head:
  - - meta
    - name: description
      content: List Models
  - - meta
    - name: keywords
      content: ShuYou, API, documentation, openai, list, models, OpenAI, Anthropic, Claude, GPT
---

# List Models

<Note>
Interactive API playground: [List Models](/en/api-reference/language-series/openai/openai-list-models).
</Note>
