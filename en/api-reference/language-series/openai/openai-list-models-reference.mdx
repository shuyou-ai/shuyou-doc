...
```text
GET https://api.shuyou.ai/v1/models
```
...
##### pricings.audio\_and\_video `array`
...
##### conditions.prompt\_tokens `object`

Token-usage condition for the input content provided by the user.

##### conditions.completion\_tokens `object`
