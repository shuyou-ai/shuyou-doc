...
head:
  ...
  - - meta
    - name: keywords
      content: AGIPower, guide, tutorial, pay, you, OpenAI, API
---

# Pay As You Go

Welcome to the **AGIPower Pay As You Go** plan! This guide will help you understand the key benefits of Pay As You Go, and how to top up, manage your balance, and create production-grade API keys.
...
**Pay As You Go** is AGIPower’s billing plan tailored for enterprise customers and production use. Unlike subscription plans, Pay As You Go uses a **prepaid balance + pay-as-you-consume** model, so you only pay for the API usage you actually consume.
...
Go to the **[AGIPower Console](https://agipower.ai/plantform/pay-as-you-go)** and navigate to **Manage > Pay As You Go**.

![Pay As You Go page](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/rsGoojf/pay-as-you-go.png)
...
![Create API key](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/BNdWYST/pay-as-you-go-details.png)
...
After creating an API key, you can use it in code to call the AGIPower API. The usage is exactly the same as in the quickstart guide—just replace it with your Pay As You Go API key:
...
![Credits breakdown](https://cdn.marmot-cloud.com/storage/agipower/2026/01/19/YqxRLvm/pay-as-you-go-keys.png)
...
- Visit the [Cost Analytics page](https://agipower.ai/settings/cost) for detailed cost attribution and usage trends
