...
- [Doubao Seedance 2.0](/en/api-reference/video-series/seedance/doubao-seedance-2.0-video-generate) — `POST /v1/predictions` (`function: video`)
- [Doubao Seedance 2.0 Fast](/en/api-reference/video-series/seedance/doubao-seedance-2.0-fast-video-generate) — `POST /v1/predictions` (`function: video`)
- [HappyHorse 1.0 T2V](/en/api-reference/video-series/happyhorse/happyhorse-1.0-t2v-video-generate) — `POST /v1/predictions` (`function: video`)
- [HappyHorse 1.0 R2V](/en/api-reference/video-series/happyhorse/happyhorse-1.0-r2v-video-generate) — `POST /v1/predictions` (`function: video`)
- [HappyHorse 1.0 I2V](/en/api-reference/video-series/happyhorse/happyhorse-1.0-i2v-video-generate) — `POST /v1/predictions` (`function: video`)
- [HappyHorse 1.0 Video Edit](/en/api-reference/video-series/happyhorse/happyhorse-1.0-video-edit-video-generate) — `POST /v1/predictions` (`function: video`)
